...
export interface ApiMediaUploadMediaUpload extends Schema.CollectionType {
...
export interface ApiPostBlogPostBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subcategory: Attribute.Relation<
      ...
      'api::subcategory.subcategory'
    >;
    thumnail: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    media_uploads: Attribute.Relation<
      'api::post-blog.post-blog',
      'oneToMany',
      'api::media-upload.media-upload'
    >;
